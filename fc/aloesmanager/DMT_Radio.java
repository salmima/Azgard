...
public class DMT_Radio extends DossierMedicoTechnique {
     ...
     */
    //ATTENTION: il faut vérifier dans l'interface que la personne est bien de secteur "imagerie" et que son statut est bien "responsable_radiologie"
    public void rechercherUnDMRadio(String IPP, String identifiant) { //identifiant de la personne connectée
        ...
        //----------- Requête 1: recherche du DMT Radio
        try {
            rechercheDMRadio = con.prepareStatement("select * from DMT_Radio where id = ?");
            rechercheDMRadio.setString(1, IPP);
        } catch (Exception e) {
        ...
        try {
            resultats_bd = rechercheDMRadio.executeQuery();
        ...
        if (r_id != null) {
            ...
            try {
                ...
                rechercheResultat.setString(2, "radiologie");
            } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        PrescriptionExamen pres = new PrescriptionExamen(dateTest, Examen.valueOf("radiologie"), PH.rechercherUnMedecin("house", "gregory"), "pres 2", "180000111", false);
//        dmt.rechercherUnDMRadio("18000011Date dateTest = new Date(118, 2, 3);1", "POLOB"); //ça marche
//        dmt.creerUnDMRadio("180000222","rien à signaler"); //ça marche
//        dmt.ajouterResultat(dateTest, pres, "180000111", "rien à redire", "tout est OK", "POLOB"); //ça marche
    }
