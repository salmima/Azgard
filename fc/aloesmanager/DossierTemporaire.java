...
//C'est à l'interface de génerer un IPP 
    ...
    /*
    * Transformation en classe Patient pour faire un message HL7
     */
    //à utiliser quand on clique sur "Créer un dossier temporaire"
    public Patient DTtoPatient() {
        char classe = 'E';

        //Création d'un patient
        Patient patient = new Patient(Integer.parseInt(this.id_urgence), this.nom, classe);
        patient.setFirstName(this.prenom);
        patient.setSex(this.sexe.charAt(0));
        patient.setBirth(this.dateNaissance);
    ...
    public static void main(String[] args) {
        ...
        dt.rechercherUnDMTemporaire("999123456", "AIMD");
    }
