...
public class DMT_Anapath extends DMT {
     ...
     */
    //ATTENTION: il faut vérifier dans l'interface que la personne est bien de secteur "anapath" et que son statut est bien "PH" 
    public void rechercherUnDMAnapath(String IPP, String identifiant) { //identifiant de la personne connectée
        Connection con = ConnexionBDD.obtenirConnection();
        PreparedStatement rechercheDMAnapath = null;
        ...
        try {
            rechercheDMAnapath = con.prepareStatement("select * from DMT_Anapath where id = ?");
            rechercheDMAnapath.setString(1, IPP);
        } catch (Exception e) {
        ...
        try {
            resultats_bd = rechercheDMAnapath.executeQuery();
        ...
        if (r_id != null) {
            //----------- Requête 2: recherche des résultats d'examen anatomopathologie
            try {
                rechercheResultat = con.prepareStatement("select * from Resultat where id = ? and type_examen = 'anatomopathologie'");
            ...
            try {
                while (resultats_bd2.next()) {
                    ...
                    if (r_ph != null) {
                        //On crée le résultat
                        resultat = new ResultatAnapathologie(r_compteRendu, r_date, r_observations2, r_id, r_ph, r_service_demandeur);
            ...
            try {
                while (resultats_bd3.next()) {
                    ...
                    try {
                        ...
                        if (r_ph2 != null) {
                            pres = new PrescriptionExamen(r_date2, Examen.valueOf("anatomopathologie"), r_ph2, r_exigences, r_id, r_done);
    ...
    public void ajouterResultat(Date date, PrescriptionExamen pres, String id, String observations, String compteRendu, String identifiant) {
        ...
        try {
            String requete = "INSERT INTO Resultat VALUES(? ,?, ?, ?, ? ,'anatomopathologie',?)";
    ...
    public boolean creerUnDMAnapath(String id, String observations) {
        ...
        try {
            String requete = "INSERT INTO DMT_Anapath VALUES(? ,?)";
    ...
    public static void main(String[] args) {
        ...
        PrescriptionExamen pres = new PrescriptionExamen(dateTest, Examen.valueOf("anatomopathologie"), PH.rechercherUnMedecin("house", "gregory"), "pres 2", "180000111", false);
//        dmt.rechercherUnDMAnapath("180000111", "HECV"); //ça marche
//        dmt.creerUnDMAnapath("180000111","anatomopathologie - bill gates"); //ça marche
//        dmt.ajouterResultat(dateTest, pres, "180000111", "", "pas de tumeur", "HECV"); //ça marche
    }
